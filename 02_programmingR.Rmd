...
- For example, we often like to "standardize" variables, that is, subtracting the sample mean, and dividing by the sample standard deviation.
...
- In this case the function returns the vector stored in the variable `result`.
